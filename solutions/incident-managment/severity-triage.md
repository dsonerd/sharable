...
flowchart TD
    ...
    Q1 -->|"Yes"| P1_SEC["🔴 <b>P1 — CRITICAL</b><br/>Security incident"]
    P1_SEC --> A_SEC["Invoke security<br/>incident playbook"]
    ...
    Q2 -->|"Yes — data<br/>may be wrong"| P1_FIN["🔴 <b>P1 — CRITICAL</b><br/>Financial integrity"]
    P1_FIN --> A_FIN["Stop writes to<br/>affected system"]
    ...
    Q3 -->|"All users /<br/>full outage"| P1_OUT["🔴 <b>P1 — CRITICAL</b><br/>Full outage"]
    P1_OUT --> A_OUT["All-hands response"]
    ...
    Q4 -->|"Yes"| P2_PEAK["🟠 <b>P2 — MAJOR</b><br/>Peak-hour degradation"]
    P2_PEAK --> A_PEAK["On-call + escalation"]
    ...
    Q4 -->|"No"| P3_OFF["🟡 <b>P3 — MINOR</b><br/>Off-peak degradation"]
    P3_OFF --> A_OFF["On-call handles"]
    A_OFF --> A_OFF1["Fix during next<br/>business day if stable"]

    Q3 -->|"Few users /<br/>partial impact"| P3_PART["🟡 <b>P3 — MINOR</b><br/>Partial impact"]
    P3_PART --> A_PART["Assigned engineer"]
    A_PART --> A_PART1["Best-effort during<br/>business hours"]

    Q3 -->|"Cosmetic /<br/>no user impact"| P4["🟢 <b>P4 — LOW</b><br/>Cosmetic / minor"]
    P4 --> A_LOW["Backlog ticket"]
    ...
    subgraph ESC ["📞 Escalation Rules"]
        direction LR
        E1["<b>P1</b><br/>IC + all engineers<br/>CTO within 15 min<br/>CEO within 1 hr"]
        E2["<b>P2</b><br/>On-call + backup<br/>IT Manager within 30 min"]
        E3["<b>P3</b><br/>Assigned engineer<br/>Team lead if no progress 2 hrs"]
        E4["<b>P4</b><br/>Sprint backlog<br/>No escalation"]
    end
    ...
    class P1_SEC,P1_FIN,P1_OUT sev1
    class P2_PEAK sev2
    class P3_OFF,P3_PART sev3
    class P4 sev4
