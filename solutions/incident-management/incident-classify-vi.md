...
Ma trận được thiết kế cho nền tảng bảo hiểm nhân thọ vận hành trên AWS, phục vụ ba nhóm người dùng: chủ hợp đồng bảo hiểm (kênh số 24/7), đại lý bán hàng/môi giới (hệ thống báo giá và đề xuất), và nhân viên nội bộ (thẩm định, bồi thường, tính toán actuarial, back-office). Các quyết định phân loại phản ánh tính chất quản lý chặt chẽ của ngành bảo hiểm nhân thọ, nơi tính chính xác và khả dụng của dữ liệu mang hệ quả tài chính và pháp lý.
...
| **Tier 1** | Hướng đại lý | Cổng đại lý, công cụ báo giá, nộp đề xuất, dashboard hoa hồng, e-application | 99.5% (giờ mở rộng: 7h--22h) | Đại lý / Môi giới |
| **Tier 2** | Nội bộ - Quan trọng | Hệ thống quản trị hợp đồng (PAS), xử lý bồi thường, workbench thẩm định, billing engine, hệ thống actuarial, báo cáo tuân thủ | 99.5% (giờ hành chính: 8h--18h T2--T7) | Nhân viên nội bộ |
...
| **OTH** | Cổng thanh toán lỗi gián đoạn (60--70% tỷ lệ thành công). API bên thứ ba phản hồi chậm gây timeout trong công cụ báo giá đại lý. Batch scheduler chạy trễ -- xử lý xuôi dòng bị chậm nhưng chưa trượt hạn. Batch tính hoa hồng thất bại (chi trả đại lý bị đe dọa). | Cao. Chức năng kinh doanh suy giảm, doanh thu hoặc sự hài lòng đại lý bị ảnh hưởng. Có thể có áp lực hạn chót. | Tier 1 (thanh toán/báo giá suy giảm cho đại lý/khách hàng) hoặc Tier 3 (batch bị chậm). | 0 phút: Trực được thông báo. 30 phút: Trưởng phòng CNTT được thông báo. Nếu batch hoa hồng: thông báo bộ phận vận hành đại lý. 2 giờ: Leo thang nếu vendor không phản hồi. | 1. Liên hệ vendor/bên thứ ba. 2. Triển khai logic thử lại hoặc fallback thủ công. 3. Batch thất bại: đánh giá cửa sổ chạy lại (có thể hoàn thành trước 6h sáng không?). 4. Thông báo đơn vị kinh doanh bị ảnh hưởng. 5. Thanh toán: chuyển sang gateway dự phòng nếu có. |
...
| Ngừng hoạt động hoàn toàn hệ thống Tier 1 | Cổng khách hàng, cổng đại lý, xử lý thanh toán |
...
| Mức ưu tiên | Truyền thông nội bộ | Truyền thông khách hàng | Truyền thông đại lý | Truyền thông pháp quy |
|----------|----------------------|----------------------|--------------------|-----------------------|
| **P1** | Kênh phòng chỉ huy. Cập nhật mỗi 30 phút. Cuộc họp bridge ban lãnh đạo. Email toàn bộ cho sự cố kéo dài (>2 giờ). | Banner bảo trì trên cổng. SMS/email cho sự cố hệ thống thanh toán. Dịch vụ khách hàng được brief với talking points. | Hotline đại lý được brief. Banner cổng đại lý. SMS broadcast cho sự cố hệ thống. Cung cấp hướng dẫn xử lý offline. | Đánh giá trong 1 giờ. Thông báo nếu vi phạm dữ liệu (PII), ngừng hoạt động kéo dài (>4 giờ hướng khách hàng), hoặc lỗi giao dịch tài chính vượt ngưỡng. |
| **P2** | Cập nhật kênh sự cố. Cập nhật mỗi 1 giờ. Đơn vị kinh doanh bị ảnh hưởng được thông báo. | Banner cổng nếu tính năng hướng khách hàng suy giảm. Cập nhật FAQ nếu khách hàng nhìn thấy. | Thông báo đại lý nếu tính năng hướng đại lý bị ảnh hưởng. Giải pháp tạm thời được truyền đạt. | Đánh giá nếu có xu hướng đạt ngưỡng pháp quy. Không thông báo chủ động trừ khi đạt ngưỡng. |
| **P3** | Kênh đội. Người dùng bị ảnh hưởng được thông báo trực tiếp. | Không truyền thông bên ngoài. | Không truyền thông trừ khi đại lý bị ảnh hưởng cụ thể. | Không. |
...
| Kịch bản | Danh mục | Mức ưu tiên | Nghiêm trọng? | Lưu ý quan trọng |
|----------|----------|----------|--------|-------------------|
| Cổng đại lý ngừng trong mùa đăng ký mở | CLD/HW | P1 | Có | Cửa sổ doanh thu quan trọng. Mỗi giờ ngừng là mất doanh số. |
| Công cụ báo giá trả phí bảo hiểm sai | SW | P1 | Có | Đại lý báo giá sai cho khách hàng. Dừng ngay. Rủi ro tài chính và pháp quy. |
| Dashboard hoa hồng đại lý không khả dụng | SW | P2 | Không | Đại lý bức xúc nhưng vẫn có thể bán. Sửa trong ngày làm việc. |
| Nộp đề xuất lỗi gián đoạn | SW | P2 | Có điều kiện | Nếu >30% tỷ lệ lỗi trong giờ hành chính: tuyên bố Nghiêm Trọng. |
| SSO đại lý lỗi cho một chi nhánh cụ thể | ACC | P2 | Không | Phạm vi hạn chế. Cung cấp thông tin đăng nhập tạm thời làm giải pháp. |
| Cổng đại lý chậm vào buổi tối | CLD/SW | P3 | Không | Đại lý làm việc buổi tối nhưng lượng thấp hơn. Lên lịch sửa ngày mai. |
...
| Batch tính hoa hồng cho số tiền sai | SW | P1 | Có | Sai lệch dữ liệu tài chính. Chi trả đại lý bị đe dọa. Giữ lại đợt thanh toán. |
...
| **Đại lý / Kênh phân phối** | Hệ thống báo giá và nộp hồ sơ cốt lõi ngừng hoặc cho số sai. Không thể tạo minh họa. Không thể nộp kinh doanh mới. Đại lý tại chi nhánh có khách hàng đang chờ mà không có hệ thống phục vụ. | Không thể báo giá hợp đồng mới. Không thể nộp đơn. Không thể xử lý gia hạn. Không thể demo sản phẩm. Doanh thu dừng hoàn toàn. |
| **Nhân viên nội bộ** | Thẩm định viên không xử lý được đơn chờ. Cán bộ bồi thường không thể phê duyệt. Tài chính không chạy được phân bổ phí hoặc đối soát. Quản lý vận hành nhận tràn ngập cuộc gọi từ đại lý. | Không thể xử lý công việc phụ thuộc hệ thống bị ảnh hưởng. Giải pháp thủ công có thể không tồn tại cho chức năng cốt lõi như tính toán hoặc thanh toán. |

**Chi phí con người của P1**: Đại lý với khách hàng ngồi đối diện, sẵn sàng mua hợp đồng, phải nói "hệ thống đang lỗi, xin quay lại hôm khác." Chủ hợp đồng thanh toán phí thất bại lo lắng hợp đồng mất hiệu lực. Cán bộ bồi thường không thể chi trả quyền lợi tử vong cho gia đình đang đau buồn.
...
| **Đại lý / Kênh phân phối** | Tính năng chính không khả dụng -- không tạo được minh họa cho một dòng sản phẩm, hoặc nộp kinh doanh mới chậm đến mức không dùng được trong giờ cao điểm. Các chức năng khác hoạt động. | Năng suất giảm nghiêm trọng. Một số sản phẩm hoặc kênh bị chặn. Đại lý có thể mất doanh số vì khách hàng không chờ. |
...
| **Đại lý / Kênh phân phối** | Lỗi hệ thống nhỏ. Vẫn bán hợp đồng và nộp đơn được. Một công cụ hỗ trợ không hoạt động (báo cáo hoa hồng, hiển thị danh sách khách hàng). | Không truy cập được một chức năng hỗ trợ. Quy trình bán hàng cốt lõi không bị ảnh hưởng. |
...
| **Đại lý / Kênh phân phối** | Vấn đề giao diện hoặc phiền toái nhỏ. Không ảnh hưởng khả năng bán hoặc phục vụ khách hàng. | Không có gì đáng kể. |
...
| **Tổn hại uy tín** | Chủ hợp đồng không truy cập được dịch vụ mất niềm tin. Đại lý không bán được mất lòng tin vào nền tảng. Tin lan nhanh qua mạng lưới đại lý. Trên kênh số, mạng xã hội khuếch đại trải nghiệm tiêu cực. | Tỷ lệ rời bỏ khách hàng khó đo lường thời gian thực nhưng tích lũy. Đại lý mất doanh số do ngừng hệ thống sẽ nhớ khi thảo luận gia hạn hợp đồng. |
...
| **Suy giảm trải nghiệm khách hàng** | Khách hàng và đại lý có thể xử lý nhưng với ma sát. Điểm hài lòng giảm. |
...
| **P1** | Đại lý / Kênh phân phối | Hệ thống thông báo đại lý, WhatsApp/Zalo broadcast, email | Trong **30 phút** | Điều gì ngừng, giải pháp tạm nếu có, khi nào cập nhật tiếp | IC + Quản lý kênh |
...
| **P2** | Đại lý (nếu hệ thống hướng đại lý bị ảnh hưởng) | Kênh thông báo đại lý | Trong **1 giờ** | Điều gì bị ảnh hưởng, giải pháp tạm, dự kiến giải quyết | Quản lý kênh |

#### Các Lỗi Truyền Thông Cần Tránh

| Lỗi | Tại sao có hại | Thay vào đó |
|---|---|---|
| "Chúng tôi đang điều tra" không có follow-up | Các bên liên quan nghĩ bạn đã quên. Đại lý gọi trực tiếp CNTT, gây gián đoạn phản hồi. | Đặt thời gian cập nhật cụ thể và tuân thủ. |
| Thuật ngữ kỹ thuật trong truyền thông khách hàng/đại lý | "DB connection pool cạn kiệt" không có nghĩa gì với đại lý đang có khách chờ. | "Hệ thống hợp đồng tạm thời không khả dụng. Chúng tôi dự kiến khôi phục trong [thời gian]." |
...
| Gửi chi tiết kỹ thuật cho đối tượng phi kỹ thuật | Gửi RCA kỹ thuật cho đại lý hoặc lãnh đạo. | Tùy chỉnh thông điệp theo đối tượng. Chi tiết kỹ thuật cho đội kỹ thuật. Tác động và timeline cho kinh doanh. |
...
Ma trận hiện tại không tính đến khi nào sự cố xảy ra. P2 lúc 2 giờ chiều Thứ Ba (giờ cao điểm bán hàng, đại lý tại chi nhánh với khách hàng) khác biệt đáng kể so với cùng sự cố lúc 11 giờ tối Thứ Bảy. Khuyến nghị:
...
4. **Tuân thủ cấp phép và đại lý.** Nếu sự cố ảnh hưởng hệ thống cấp phép đại lý, tính hoa hồng, hoặc báo cáo tuân thủ lực lượng bán hàng, hệ quả pháp quy mở rộng ra ngoài CNTT sang tuân thủ phân phối.
